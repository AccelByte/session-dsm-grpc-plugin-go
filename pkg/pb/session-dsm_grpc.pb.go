...
const (
	SessionDsm_CreateGameSession_FullMethodName      = "/accelbyte.session.sessiondsm.SessionDsm/CreateGameSession"
	SessionDsm_TerminateGameSession_FullMethodName   = "/accelbyte.session.sessiondsm.SessionDsm/TerminateGameSession"
	SessionDsm_CreateGameSessionAsync_FullMethodName = "/accelbyte.session.sessiondsm.SessionDsm/CreateGameSessionAsync"
)
...
func (c *sessionDsmClient) CreateGameSession(ctx context.Context, in *RequestCreateGameSession, opts ...grpc.CallOption) (*ResponseCreateGameSession, error) {
	...
	err := c.cc.Invoke(ctx, SessionDsm_CreateGameSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionDsmClient) TerminateGameSession(ctx context.Context, in *RequestTerminateGameSession, opts ...grpc.CallOption) (*ResponseTerminateGameSession, error) {
	...
	err := c.cc.Invoke(ctx, SessionDsm_TerminateGameSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionDsmClient) CreateGameSessionAsync(ctx context.Context, in *RequestCreateGameSession, opts ...grpc.CallOption) (*ResponseCreateGameSessionAsync, error) {
	...
	err := c.cc.Invoke(ctx, SessionDsm_CreateGameSessionAsync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedSessionDsmServer
...
// UnimplementedSessionDsmServer should be embedded to have
...
func (UnimplementedSessionDsmServer) CreateGameSession(context.Context, *RequestCreateGameSession) (*ResponseCreateGameSession, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateGameSession not implemented")
}
func (UnimplementedSessionDsmServer) TerminateGameSession(context.Context, *RequestTerminateGameSession) (*ResponseTerminateGameSession, error) {
	return nil, status.Error(codes.Unimplemented, "method TerminateGameSession not implemented")
}
func (UnimplementedSessionDsmServer) CreateGameSessionAsync(context.Context, *RequestCreateGameSession) (*ResponseCreateGameSessionAsync, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateGameSessionAsync not implemented")
}
func (UnimplementedSessionDsmServer) testEmbeddedByValue() {}
...
func RegisterSessionDsmServer(s grpc.ServiceRegistrar, srv SessionDsmServer) {
	// If the following call panics, it indicates UnimplementedSessionDsmServer was
...
func _SessionDsm_CreateGameSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionDsm_CreateGameSession_FullMethodName,
	}
...
func _SessionDsm_TerminateGameSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionDsm_TerminateGameSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SessionDsm_CreateGameSessionAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionDsm_CreateGameSessionAsync_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
